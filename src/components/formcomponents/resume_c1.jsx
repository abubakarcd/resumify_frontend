        ...
        <>
          ...
          >
            <div className="resume1-header">
              <h1 className="resume1-name">
                {personalinfo.name.toUpperCase()}
              </h1>
              <p className="resume1-title">
                          ...
                          {experience_loop.responsibility.length != 0
                            ? experience_loop.responsibility.map(
                                (responsibilities, index) => (
                                  <ul
                                    className="resume1_expereience_list"
                                    key={`responsibilti-${index}`}
                                  >
                                    <li>
                                      {responsibilities
                                        .charAt(0)
                  ...
                  {certification_info.length !== 0
                    ? certification_info.map((certificates, index) => (
                        ...
                        >
                          ...
                          <p className="resume1-organization">
